...
class GameView extends GLSurfaceView implements View.OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        NativeLib.onTouch(event.getX(), event.getY(), event.getAction());
        return true;
    }
    ...
    private static class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            NativeLib.init(GameView.assetManager, GameView.internalPath);
        }
    }
}
